package io.yorez.web.rest.errors
...
class ExceptionTranslator(private val env: Environment) : ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    fun handleEmailAlreadyUsedException(ex: io.yorez.service.EmailAlreadyUsedException, request: NativeWebRequest): ResponseEntity<Problem>? {
    ...
    @ExceptionHandler
    fun handleUsernameAlreadyUsedException(ex: io.yorez.service.UsernameAlreadyUsedException, request: NativeWebRequest): ResponseEntity<Problem>? {
        val problem = LoginAlreadyUsedException()
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName, true, problem.entityName, problem.errorKey, problem.message))
    }

    @ExceptionHandler
    fun handleInvalidPasswordException(ex: io.yorez.service.InvalidPasswordException, request: NativeWebRequest): ResponseEntity<Problem>? {
    ...
    private fun containsPackageName(message: String?) = listOf("org.", "java.", "net.", "javax.", "com.", "io.", "de.", "io.yorez").any { it == message }
}
