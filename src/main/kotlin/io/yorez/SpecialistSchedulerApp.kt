...
import io.yorez.config.ApplicationProperties
import io.yorez.config.CRLFLogConverter
...
class SpecialistSchedulerApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes SpecialistScheduler.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<SpecialistSchedulerApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(SpecialistSchedulerApp::class.java)
