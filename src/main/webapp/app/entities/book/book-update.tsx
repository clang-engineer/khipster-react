  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="specialistSchedulerApp.book.home.createOrEditLabel" data-cy="BookCreateUpdateHeading">
            <Translate contentKey="specialistSchedulerApp.book.home.createOrEditLabel">Create or edit a Book</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('specialistSchedulerApp.book.title')}
                id="book-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('specialistSchedulerApp.book.description')}
                id="book-description"
                name="description"
                data-cy="description"
                type="text"
