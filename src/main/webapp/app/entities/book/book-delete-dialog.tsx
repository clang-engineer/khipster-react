...
export const BookDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="specialistSchedulerApp.book.delete.question">
        <Translate contentKey="specialistSchedulerApp.book.delete.question" interpolate={{ id: bookEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="tbl-confirm-delete-book" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
